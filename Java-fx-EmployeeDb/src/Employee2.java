...
public abstract class Employee2 {
	 ...
	 */
	public Employee2(String login,double salary,String name,String dateAdded) {
		this.loginName = login;
		this.baseSalary = salary;
		this.employeeName = name;	
		this.addedDate = dateAdded;
		this.employeeId = Employee2.nextId++;
	}
	...
	public Employee2(int eId, String login,double salary,String name, String dateAdded) {
		this.loginName = login;
		this.baseSalary = salary;
		this.employeeName = name;	
		this.addedDate = dateAdded;
		this.employeeId = eId;
		Employee2.nextId = eId + 1;
	}
